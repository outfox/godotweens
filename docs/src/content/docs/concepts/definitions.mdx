...
snapshotting and may override any option. Alternatively, pass a shared `TweenOptions`
object; its options are copied, but the explicit duration argument wins.
