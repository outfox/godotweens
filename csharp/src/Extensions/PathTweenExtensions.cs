...
public static partial class TweenExtensions
{
    ...
    public static TweenInstance<PathFollow2D, float> TweenProgress(this PathFollow2D target,
        ...
        => target.Tween(ApplyOptions(new PathFollow2DProgressTween { To = to, Duration = duration }, options));
    ...
    public static TweenInstance<PathFollow2D, float> TweenProgressRatio(this PathFollow2D target,
        float to, double duration, TweenOptions options)
        => target.Tween(ApplyOptions(new PathFollow2DProgressRatioTween { To = to, Duration = duration }, options));
    ...
    public static TweenInstance<PathFollow2D, float> TweenHOffset(this PathFollow2D target,
        float to, double duration, TweenOptions options)
        => target.Tween(ApplyOptions(new PathFollow2DHOffsetTween { To = to, Duration = duration }, options));
    ...
    public static TweenInstance<PathFollow2D, float> TweenVOffset(this PathFollow2D target,
        float to, double duration, TweenOptions options)
        => target.Tween(ApplyOptions(new PathFollow2DVOffsetTween { To = to, Duration = duration }, options));
    ...
    public static TweenInstance<PathFollow3D, float> TweenProgress(this PathFollow3D target,
        float to, double duration, TweenOptions options)
        => target.Tween(ApplyOptions(new PathFollow3DProgressTween { To = to, Duration = duration }, options));
    ...
    public static TweenInstance<PathFollow3D, float> TweenProgressRatio(this PathFollow3D target,
        float to, double duration, TweenOptions options)
        => target.Tween(ApplyOptions(new PathFollow3DProgressRatioTween { To = to, Duration = duration }, options));
    ...
    public static TweenInstance<PathFollow3D, float> TweenHOffset(this PathFollow3D target,
        float to, double duration, TweenOptions options)
        => target.Tween(ApplyOptions(new PathFollow3DHOffsetTween { To = to, Duration = duration }, options));
    ...
    public static TweenInstance<PathFollow3D, float> TweenVOffset(this PathFollow3D target,
        float to, double duration, TweenOptions options)
        => target.Tween(ApplyOptions(new PathFollow3DVOffsetTween { To = to, Duration = duration }, options));
}
